...
namespace Cf.Libs.Service.Settings
{
    public class SettingService : BaseService, ISettingService
    {
        ...
        public T Get<T>(string settingKey) where T : class, new()
        {
        ...
        public bool Save<T>(string settingKey, T model) where T : class, new()
        {
            var record = _settingRepository.FindByKey(settingKey.ToString());
        ...
        public bool Save(string key, string[] model)
        {
        ...
        public bool Delete(string settingKey)
        {
            var record = _settingRepository.FindByKey(settingKey.ToString());
            if (record == null)
            {
